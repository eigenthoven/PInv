...
h_extprov = float(input("Viento en exterior: (interior tranquilo / exterior sin viento / brisa / viento moderado / viento fuerte): "))
h_intprov = float(input("Viento en interior: (interior tranquilo / exterior sin viento / brisa / viento moderado / viento fuerte): "))
if h_extprov == 
